  ...
  return (
    <div className="bg-slate-50/50 min-h-screen overflow-x-hidden">
      ...
      >
        ...
        {/* Hero Section */}
        <section className="relative pt-8 pb-16 md:pt-14 md:pb-20 px-6 max-w-7xl mx-auto z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-left">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-50/80 border border-indigo-100 text-indigo-700 text-xs font-bold uppercase tracking-wider shadow-sm backdrop-blur-xs">
            ...
            <h1 className="text-4xl md:text-5xl xl:text-6xl font-extrabold text-slate-900 tracking-tight leading-[1.1] flex flex-col gap-2">
              ...
              <span className="bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 bg-clip-text text-transparent italic font-serif font-semibold tracking-normal text-xl md:text-2xl xl:text-3xl leading-snug">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3">
              <Link
                href="/marketplace"
                className="w-full sm:w-auto bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 text-white px-6 py-3 rounded-full font-bold text-sm hover:shadow-lg hover:shadow-indigo-200/50 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-2 group shadow-md"
              >
              ...
              {(!session?.user || (session.user as any).role === "SELLER") && (
                <Link
                  href="/onboarding"
                  className="w-full sm:w-auto bg-white border border-indigo-100 text-indigo-600 px-6 py-3 rounded-full font-bold text-sm hover:bg-indigo-50/20 hover:border-indigo-200 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 text-center shadow-sm"
                >
                  List Your Startup
                </Link>
              )}
            ...
            {/* Badges/Trust Row */}
            <div className="pt-2 flex flex-wrap gap-2 text-slate-500 font-semibold text-xs">
              <div className="flex items-center gap-1.5 bg-white px-3 py-1.5 rounded-xl border border-slate-100/80 shadow-xs">
              ...
              <div className="space-y-2.5">
                ...
                <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-100 text-center space-y-1.5">
                  <div>
                    ...
                    <p className="text-sm font-black text-slate-800 mt-0.5">$2.4M</p>
                  </div>
                ...
                <button className="w-full py-1.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg text-[8px] font-extrabold tracking-wide hover:opacity-90 cursor-pointer shadow-sm active:scale-[0.98] transition-all">
                  View Details
                </button>
              </div>
            </div>
